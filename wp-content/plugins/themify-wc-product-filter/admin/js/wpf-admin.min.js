'use strict';(function(b){window.addEventListener("load",function(){b("body").on("click","a.wpf_lightbox",function(a){a.preventDefault();a.stopPropagation();var c=b(this);b.ajax({url:this,success:function(d){if(d){var m=c.attr("title"),l=c.data("class"),k=c.data("top");a.preventDefault();b(document).on("keyup",g);var f="wpf_"+Math.random().toString(36).substr(2,9);d='<div id="'+f+'" class="wpf_admin_lightbox wpf_interface"><div class="wpf_lightbox_title">'+m+'</div><a href="#" class="wpf_close_lightbox">\u00d7</a><div id="wpf_lightbox_container"><div class="wpf_lightbox_inner">'+
d+'</div></div></div><div class="wpf_overlay"></div>';b("body").append(d);k||(k=100);l&&b("#"+f).addClass(l);b.event.trigger("WPF.openlightbox",[a,f]);b("#"+f).nextAll(".wpf_overlay").show();b("#"+f).show().css("top",h()).animate({top:k},800);b("#"+f).find(".wpf_close_lightbox").click(e)}}})}).on("click",".wpf_delete",function(a){if(confirm(wpf_js.template_delete)){var c=b(this),d=c.closest("table");b.ajax({url:this,dataType:"json",beforeSend:function(){d.addClass("wpf_save")},complete:function(){d.removeClass("wpf_save")},
success:function(a){a&&"1"==a.status&&c.closest("tr").remove()}})}a.preventDefault()}).on("click",".open_media_uploader_image",function(a){var c=b(this).closest(".wpf_background_image"),d=wp.media({frame:"post",state:"insert",multiple:!1});d.open();d.on("insert",function(){var a=d.state().get("selection").first().toJSON();c.find("input").val(a.url);c.find("img").attr("src",a.url);c.addClass("has-image")});a.preventDefault()}).on("click",".remove-background",function(a){var c=b(this).closest(".wpf_background_image");
1==confirm("Remove background image?")&&(c.find("input").val(""),c.find("img").attr("src",""),c.removeClass("has-image"));a.preventDefault()})},{once:!0,passive:!0});var h=function(){var a=document;return Math.max(Math.max(a.body.scrollHeight,a.documentElement.scrollHeight),Math.max(a.body.offsetHeight,a.documentElement.offsetHeight),Math.max(a.body.clientHeight,a.documentElement.clientHeight))},g=function(a){27===a.keyCode&&(a.preventDefault(),e(a))},e=function(a){a.preventDefault();b(document).off("keyup",
g);var c=b(this).closest(".wpf_admin_lightbox");b.event.trigger("WPF.close_lightbox",this);c.animate({top:h()},800,function(){c.next(".wpf_overlay").remove();c.remove()})}})(jQuery);
