...
data:{action:"wpf_get_list"},beforeSend:function(){e.addClass(a+"wait")},complete:function(){e.removeClass(a+"wait")},success:function(a){a&&e.replaceWith(b(a).find("#the-list"))}})}})},AddItem:function(){b("#"+WPF.prefix+"module_content").on("click","."+WPF.prefix+"add_item",function(a){a.preventDefault();a=b(this).prev("ul").children("li").first().clone();a.hide().find("input").val("");b(this).prev("ul").append(a);a.slideDown()})},RemmoveItem:function(){b("#"+WPF.prefix+"module_content").on("click",
...
a.children("a").attr("class")+'"]').addClass("wpf_active_lng")}})},getTax:function(a){b.ajax({url:a.dataset.url,success:function(b){b&&(a.innerHTML=b,a.dataset.url="",WPF.multiLanguages(),WPF.SetupColors())}})}}})(jQuery,window,document);
